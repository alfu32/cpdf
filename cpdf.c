...
//extern "C" {
    ...
    #endif /* HAVE_LIBGD13 */
    #include <cpdflib.h>
    #undef CPDFLIB_CHECK_OPEN_BASEDIR
    #ifdef HAVE_UNISTD_H
    # include <unistd.h>
    #endif
    #ifdef PHP_WIN32
    ...
    zend_function_entry cpdf_functions[] = {
    ...
    PHP_MINFO_FUNCTION(cpdf) {
            ...
            php_info_print_table_header(2, "CPDF Support", "enabled");
            php_info_print_table_row(2, "Version", cpdf_version() );
            php_info_print_table_row(2, "Extension version", PHP_CPDF_VERSION);
    ...
    PHP_FUNCTION(cpdf_open)
    {
    ...
    #endif
    #ifdef CPDFLIB_CHECK_OPEN_BASEDIR
            ...
            id = zend_list_insert(cpdf, CPDF_GLOBAL(le_cpdf) TSRMLS_CC);
    #else
    ...
    */
    ...
    /*              php_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to find last outline entry %d", id);
            ...
            lastoutline = cpdf_addOutlineEntry(pdf, lastoutline,
                                 ...
                                 1, 0.0, 0.0, 0.0, 0.0);
    #if PHP_MAJOR_VERSION >= 5 && PHP_MINOR_VERSION >= 4
            id = zend_list_insert(lastoutline, CPDF_GLOBAL(le_outline) TSRMLS_CC);
    #else
